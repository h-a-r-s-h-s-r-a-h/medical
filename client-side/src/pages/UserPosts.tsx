          ...
          >
            ...
            >
              ...
              <div className="mt-6 flex items-center justify-between">
                ...
                <button className="flex items-center px-4 py-2 rounded-full text-sm font-medium bg-gradient-to-r from-blue-500 to-blue-600 text-white shadow-lg transform transition-all duration-300 hover:scale-105 hover:shadow-xl">
